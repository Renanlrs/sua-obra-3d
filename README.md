...
### 📱 Ver no celular e em AR (23/09)
Menu **⋯ → Ver no celular / AR**: o projeto inteiro é comprimido (gzip do navegador) e vai **dentro do link**, na hash — nada sobe para servidor nenhum. O app desenha o **QR ali mesmo** (gerador próprio em `qr.js`, sem internet e sem biblioteca: Reed-Solomon, máscara, versões 1–40 nível L). O cliente aponta a câmera, abre o mesmo app já com a casa carregada e cai direto no 3D. O QR nasce leve (sem os móveis) porque QR denso a câmera não lê; dá para pôr os móveis, **ampliar em tela cheia** (validado: lido com leitor externo) ou **copiar o link completo** para mandar no WhatsApp.
No **Android com Chrome** aparece **Ver em AR**: WebXR com *hit-test* — um retículo procura o chão, você toca e a casa é ancorada ali, em **maquete 1:50, 1:10 ou tamanho real**, com botões para girar e sair. No iPhone o link abre o 3D normal (girar, andar, passear).
